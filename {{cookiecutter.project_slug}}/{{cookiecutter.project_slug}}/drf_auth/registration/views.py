...
from {{cookiecutter.project_slug}}.drf_auth.app_settings import (
    JWTSerializer, TokenSerializer, create_token,
)
from {{cookiecutter.project_slug}}.drf_auth.models import TokenModel
from {{cookiecutter.project_slug}}.drf_auth.registration.serializers import (
...
from {{cookiecutter.project_slug}}.drf_auth.utils import jwt_encode
from {{cookiecutter.project_slug}}.drf_auth.views import LoginView
...
class RegisterView(CreateAPIView):
    ...
    throttle_scope = '{{cookiecutter.project_slug}}.drf_auth'
