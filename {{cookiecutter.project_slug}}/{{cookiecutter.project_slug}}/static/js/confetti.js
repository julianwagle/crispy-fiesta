...
const createConfetti = function(item_id, confettiItems) {

    let x = document.documentElement.clientWidth / 2;
    let y = document.documentElement.clientHeight / 2.75;
    ...
    let maxSpeed = 60000; // Pixels * 1000
    let minSpeed = 30000; // Pixels * 1000
